...
// ✅ CORREÇÃO: Função prevImage() estava incompleta
function prevImage() {
...
document.querySelector("[data-next]")?.addEventListener("click", nextImage);
document.querySelector("[data-prev]")?.addEventListener("click", prevImage);

// Abrir lightbox ao clicar na galeria
document.querySelectorAll(".gallery__item").forEach((btn, index) => {
